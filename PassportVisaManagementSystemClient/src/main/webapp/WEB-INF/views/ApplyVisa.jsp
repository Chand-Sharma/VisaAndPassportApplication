...
<body>
	...
	<div class="c">
		...
		<form action="/applyPassInput" method="post">
			<fieldset>
				<legend class="legend">Apply Visa Page:</legend>
				...
				<input	type="text" class="input" name="destination"><br> <br> 
				
				

				<label class="label" for="employeeOccupation">Employee Occupation:</label> 
				<select id="employeeOccupation" name="employeeOccupation">
